...
<html>
    ...
    <center>
        ...
        <hr><a href="http://localhost:8080/SistemaPREP/Registro.jsp" class="link-success"><h1><i class="fas fa-user-plus" title="Crear cuenta"></i></h1></a></hr><br>
        <hr><a href="" class="link-success"><h1><i class="fas fa-unlock-alt" title="Recuperar contraseña"></i></h1></a></hr>
        </center>
